...
#EXTINF:-1 group-title="SPORT LOCAL" tvg-logo="https://i.imgur.com/am6VNky.png?height=auto&width=288&croppingPoint=&version=1&type=png" ,USE SPORT 1
...
#EXTINF:-1 group-title="SPORT LOCAL" tvg-logo="https://i.imgur.com/am6VNky.png?height=auto&width=288&croppingPoint=&version=1&type=png" ,USE SPORT 2
#EXTVLCOPT:network-caching=1000
#EXTVLCOPT:http-user-agent="FireFox"
#EXTVLCOPT--http-reconnect=true
#KODIPROP:inputstreamaddon=inputstream.adaptive
